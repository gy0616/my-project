...
class RandomHorizontalFlip_edge(object):
    def __call__(self, sample):
        img = sample['image']
        mask = sample['label']
        edge = sample['edge']
...
class RandomGaussianBlur_edge(object):
    def __call__(self, sample):
        img = sample['image']
        mask = sample['label']
        edge = sample['edge']
...
class FixScaleCrop_edge(object):
    def __init__(self, crop_size):
        self.crop_size = crop_size
